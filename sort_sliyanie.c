...
int *sort_sliyaniem(int *a, int *b, size_t l, size_t r)
{
	...
	l_current = l; 	// l_c и r_c нужны для вытягивания элементов из массива, на который указывают левая и правая части. Это могут быть 
			// либо буфер либо основной массивы.
	r_current = m + 1;
	for (i = l; i <= r; i++) {
